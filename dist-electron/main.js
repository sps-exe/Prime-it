...
import electron, { ipcMain as ipcMain$1, screen, shell as shell$1, app as app$1, BrowserWindow } from "electron";
...
const windows = (name) => {
  const appData = env.APPDATA || path$m.join(homedir, "AppData", "Roaming");
  ...
  return {
    ...
    config: path$m.join(appData, name, "Config"),
...
function checkDataTypes$1(dataTypes, data, strictNums, correct) {
  ...
  let cond;
  const types2 = (0, util_1$10.toHash)(dataTypes);
...
function getTypeErrorContext$1(it) {
  ...
  const schemaCode = (0, util_1$10.schemaRefOrVal)(it, schema2, "type");
  return {
    gen,
    keyword: "type",
    data,
...
function schemaProperties$1(it, schemaMap) {
  return allSchemaProperties$1(schemaMap).filter((p) => !(0, util_1$_.alwaysValidSchema)(it, schemaMap[p]));
}
  ...
  function validateItems(notValid) {
    ...
    gen.forRange("i", 0, len, (i) => {
      cxt.subschema({
        keyword: keyword2,
        dataProp: i,
        dataPropType: util_1$_.Type.Num
      }, valid2);
...
function validateUnion$1(cxt) {
  ...
  if (!Array.isArray(schema2))
    throw new Error("ajv implementation error");
  const alwaysValid = schema2.some((sch) => (0, util_1$_.alwaysValidSchema)(it, sch));
...
function extendSubschemaData$1(subschema2, it, { dataProp, dataPropType: dpType, data, dataTypes, propertyName }) {
  ...
  if (dataProp !== void 0) {
    ...
    subschema2.errorPath = (0, codegen_1$Y.str)`${errorPath}${(0, util_1$Z.getErrorPath)(dataProp, dpType, opts.jsPropertySyntax)}`;
...
function countKeys$1(schema2) {
  ...
  for (const key in schema2) {
    ...
    if (typeof schema2[key] == "object") {
      (0, util_1$Y.eachItem)(schema2[key], (sch) => count += countKeys$1(sch));
    }
    if (count === Infinity)
      return Infinity;
  }
...
function getData$1($data, { dataLevel, dataNames, dataPathArr }) {
  ...
  for (const segment of segments) {
    if (segment) {
      data = (0, codegen_1$X._)`${data}${(0, codegen_1$X.getProperty)((0, util_1$X.unescapeJsonPointer)(segment))}`;
...
function resolveRef$1(root2, baseId, ref2) {
  ...
  if (schOrFunc)
    return schOrFunc;
  let _sch = resolve$3.call(this, root2, ref2);
  if (_sch === void 0) {
    const schema2 = (_a = root2.localRefs) === null || _a === void 0 ? void 0 : _a[ref2];
    const { schemaId } = this.opts;
    if (schema2)
      _sch = new SchemaEnv$1({ schema: schema2, schemaId, root: root2, baseId });
  }
  if (_sch === void 0)
    return;
  return root2.refs[ref2] = inlineOrCompile$1.call(this, _sch);
}
...
function resolve$3(root2, ref2) {
  let sch;
  while (typeof (sch = this.refs[ref2]) == "string")
    ref2 = sch;
  return sch || this.schemas[ref2] || resolveSchema$1.call(this, root2, ref2);
}
...
function getJsonPointer$1(parsedRef, { baseId, schema: schema2, root: root2 }) {
  var _a;
  ...
  const { schemaId } = this.opts;
  env2 = env2 || new SchemaEnv$1({ schema: schema2, schemaId, root: root2, baseId });
...
const def$11 = {
  ...
  code(cxt) {
    ...
    if (($ref === "#" || $ref === "#/") && baseId === root2.baseId)
      return callRootRef();
    const schOrEnv = compile_1$4.resolveRef.call(self2, root2, baseId, $ref);
    if (schOrEnv === void 0)
    ...
    function callRootRef() {
      ...
      return callRef$1(cxt, (0, codegen_1$V._)`${rootName}.validate`, root2, root2.$async);
    }
  ...
  function addEvaluatedFrom(source) {
    ...
    if (it.props !== true) {
      if (schEvaluated && !schEvaluated.dynamicProps) {
        ...
        it.props = util_1$V.mergeEvaluated.props(gen, props, it.props, codegen_1$V.Name);
      }
    }
    if (it.items !== true) {
      if (schEvaluated && !schEvaluated.dynamicItems) {
        ...
        it.items = util_1$V.mergeEvaluated.items(gen, items2, it.items, codegen_1$V.Name);
      }
    }
  }
}
...
const def$_ = {
  ...
  code(cxt) {
    ...
    const len = it.opts.unicode === false ? (0, codegen_1$S._)`${data}.length` : (0, codegen_1$S._)`${(0, util_1$U.useFunc)(cxt.gen, ucs2length_1$1.default)}(${data})`;
...
const def$Z = {
  ...
  code(cxt) {
    ...
    const regExp = $data ? (0, codegen_1$R._)`(new RegExp(${schemaCode}, ${u2}))` : (0, code_1$i.usePattern)(cxt, schema2);
...
const def$V = {
  ...
  code(cxt) {
    ...
    function loopN2(i, j) {
      const eql = (0, util_1$S.useFunc)(gen, equal_1$5.default);
...
const def$U = {
  ...
  code(cxt) {
    ...
    if ($data || schema2 && typeof schema2 == "object") {
      cxt.fail$data((0, codegen_1$M._)`!${(0, util_1$R.useFunc)(gen, equal_1$4.default)}(${data}, ${schemaCode})`);
    } else {
...
const def$T = {
  ...
  code(cxt) {
    ...
    let eql;
    const getEql = () => eql !== null && eql !== void 0 ? eql : eql = (0, util_1$Q.useFunc)(gen, equal_1$3.default);
    let valid2;
    if (useLoop || $data) {
...
function _getValidate(cxt) {
  ...
  const sch = new compile_1$3.SchemaEnv({ schema: schema2, schemaId, root: root2, baseId, localRefs, meta });
...
const def$B = {
  ...
  code(cxt) {
    if (cxt.schema)
      ...
      (0, util_1$C.checkStrictMode)(cxt.it, "$recursiveAnchor: false is ignored");
  }
};
...
const def$x = {
  ...
  code({ keyword: keyword2, parentSchema, it }) {
    if (parentSchema.contains === void 0) {
      (0, util_1$B.checkStrictMode)(it, `"${keyword2}" without "contains" is ignored`);
    }
  }
};
...
const def$v = {
  ...
  code(cxt) {
    ...
    } else if (typeof schema2 == "object" && !(0, util_1$z.alwaysValidSchema)(it, schema2)) {
    ...
    function validateItems(valid2, from) {
      gen.forRange("i", from, len, (i) => {
        cxt.subschema({ keyword: "unevaluatedItems", dataProp: i, dataPropType: util_1$z.Type.Num }, valid2);
        if (!it.allErrors)
...
const codegen_1$w = codegen$1;
const types_1$7 = types$2;
const compile_1$2 = compile$1;
const ref_error_1$2 = ref_error$1;
const util_1$y = util$4;
const error$k = {
  message: ({ params: { discrError, tagName } }) => discrError === types_1$7.DiscrError.Tag ? `tag "${tagName}" must be string` : `value of tag "${tagName}" must be in oneOf`,
...
const def$t = {
  ...
  code(cxt) {
    ...
    gen.if((0, codegen_1$w._)`typeof ${tag} == "string"`, () => validateMapping(), () => cxt.error(false, { discrError: types_1$7.DiscrError.Tag, tag, tagName }));
    cxt.ok(valid2);
    function validateMapping() {
      ...
      gen.else();
      cxt.error(false, { discrError: types_1$7.DiscrError.Mapping, tag, tagName });
      gen.endIf();
    }
    ...
    function getMapping() {
      ...
      for (let i = 0; i < oneOf2.length; i++) {
        let sch = oneOf2[i];
        if ((sch === null || sch === void 0 ? void 0 : sch.$ref) && !(0, util_1$y.schemaHasRulesButRef)(sch, it.self.RULES)) {
          const ref2 = sch.$ref;
...
function getTypeErrorContext(it) {
  const { gen, data, schema: schema2 } = it;
  const schemaCode = (0, util_1$x.schemaRefOrVal)(it, schema2, "type");
  return {
    gen,
    keyword: "type",
    data,
...
function validateUnion(cxt) {
  ...
  if (!Array.isArray(schema2))
    throw new Error("ajv implementation error");
  const alwaysValid = schema2.some((sch) => (0, util_1$v.alwaysValidSchema)(it, sch));
  if (alwaysValid && !it.opts.unevaluated)
    return;
  const valid2 = gen.let("valid", false);
  const schValid = gen.name("_valid");
...
function extendSubschemaData(subschema2, it, { dataProp, dataPropType: dpType, data, dataTypes, propertyName }) {
  ...
  if (dataProp !== void 0) {
    ...
    dataContextProps(nextData);
    subschema2.errorPath = (0, codegen_1$o.str)`${errorPath}${(0, util_1$u.getErrorPath)(dataProp, dpType, opts.jsPropertySyntax)}`;
...
function countKeys(schema2) {
  ...
  for (const key in schema2) {
    ...
    if (SIMPLE_INLINED.has(key))
      continue;
    if (typeof schema2[key] == "object") {
      (0, util_1$t.eachItem)(schema2[key], (sch) => count += countKeys(sch));
    }
    if (count === Infinity)
      return Infinity;
  }
...
function checkRefsAndKeywords(it) {
  const { schema: schema2, errSchemaPath, opts, self: self2 } = it;
  if (schema2.$ref && opts.ignoreKeywordsWithRef && (0, util_1$s.schemaHasRulesButRef)(schema2, self2.RULES)) {
    self2.logger.warn(`$ref: keywords ignored in schema at path "${errSchemaPath}"`);
  }
}
...
function schemaKeywords(it, types2, typeErrors, errsCount) {
  const { gen, schema: schema2, data, allErrors, opts, self: self2 } = it;
  const { RULES } = self2;
  if (schema2.$ref && (opts.ignoreKeywordsWithRef || !(0, util_1$s.schemaHasRulesButRef)(schema2, RULES))) {
...
function getData($data, { dataLevel, dataNames, dataPathArr }) {
  ...
  for (const segment of segments) {
    if (segment) {
      data = (0, codegen_1$n._)`${data}${(0, codegen_1$n.getProperty)((0, util_1$s.unescapeJsonPointer)(segment))}`;
...
function resolveRef(root2, baseId, ref2) {
  ...
  if (_sch === void 0) {
    ...
    const { schemaId } = this.opts;
    if (schema2)
      _sch = new SchemaEnv2({ schema: schema2, schemaId, root: root2, baseId });
  }
  if (_sch === void 0)
    return;
...
function resolveSchema(root2, ref2) {
  ...
  if (id2 === (0, resolve_1.normalizeId)(ref2)) {
    ...
    return new SchemaEnv2({ schema: schema2, schemaId, root: root2, baseId });
  }
...
function getJsonPointer(parsedRef, { baseId, schema: schema2, root: root2 }) {
  ...
  for (const part of parsedRef.fragment.slice(1).split("/")) {
    if (typeof schema2 === "boolean")
      return;
    const partSchema = schema2[(0, util_1$r.unescapeFragment)(part)];
    if (partSchema === void 0)
      return;
    schema2 = partSchema;
    const schId = typeof schema2 === "object" && schema2[this.opts.schemaId];
  ...
  let env2;
  if (typeof schema2 != "boolean" && schema2.$ref && !(0, util_1$r.schemaHasRulesButRef)(schema2, this.RULES)) {
    const $ref = (0, resolve_1.resolveUrl)(this.opts.uriResolver, baseId, schema2.$ref);
    env2 = resolveSchema.call(this, root2, $ref);
  }
  const { schemaId } = this.opts;
  env2 = env2 || new SchemaEnv2({ schema: schema2, schemaId, root: root2, baseId });
  if (env2.schema !== env2.root.schema)
    return env2;
  return void 0;
}
  ...
  function addEvaluatedFrom(source) {
    ...
    if (it.props !== true) {
      if (schEvaluated && !schEvaluated.dynamicProps) {
        ...
        it.props = util_1$q.mergeEvaluated.props(gen, props, it.props, codegen_1$l.Name);
      }
    }
    if (it.items !== true) {
      if (schEvaluated && !schEvaluated.dynamicItems) {
        ...
        it.items = util_1$q.mergeEvaluated.items(gen, items2, it.items, codegen_1$l.Name);
      }
    }
  }
}
...
const def$o = {
  ...
  code(cxt) {
    ...
    const len = it.opts.unicode === false ? (0, codegen_1$i._)`${data}.length` : (0, codegen_1$i._)`${(0, util_1$p.useFunc)(cxt.gen, ucs2length_1.default)}(${data})`;
    ...
    if (opts.strictRequired) {
      ...
      for (const requiredKey of schema2) {
        if ((props === null || props === void 0 ? void 0 : props[requiredKey]) === void 0 && !definedProperties.has(requiredKey)) {
          const schemaPath = it.schemaEnv.baseId + it.errSchemaPath;
          const msg = `required property "${requiredKey}" is not defined at "${schemaPath}" (strictRequired)`;
          (0, util_1$o.checkStrictMode)(it, msg, it.opts.strictRequired);
        }
      }
    }
    function allErrorsMode() {
...
const def$j = {
  ...
  code(cxt) {
    ...
    function loopN2(i, j) {
      const eql = (0, util_1$n.useFunc)(gen, equal_1$2.default);
      const outer = gen.name("outer");
...
const def$i = {
  ...
  code(cxt) {
    const { gen, data, $data, schemaCode, schema: schema2 } = cxt;
    if ($data || schema2 && typeof schema2 == "object") {
      cxt.fail$data((0, codegen_1$c._)`!${(0, util_1$m.useFunc)(gen, equal_1$1.default)}(${data}, ${schemaCode})`);
    } else {
...
const def$h = {
  ...
  code(cxt) {
    ...
    const useLoop = schema2.length >= it.opts.loopEnum;
    let eql;
    const getEql = () => eql !== null && eql !== void 0 ? eql : eql = (0, util_1$l.useFunc)(gen, equal_1.default);
    let valid2;
    if (useLoop || $data) {
      valid2 = gen.let("valid");
      cxt.block$data(valid2, loopEnum);
...
const def$g = {
  ...
  code(cxt) {
    ...
    const { items: items2 } = parentSchema;
    if (!Array.isArray(items2)) {
      (0, util_1$k.checkStrictMode)(it, '"additionalItems" is ignored when "items" is not an array of schemas');
      return;
    }
...
function validateAdditionalItems(cxt, items2) {
  ...
  } else if (typeof schema2 == "object" && !(0, util_1$k.alwaysValidSchema)(it, schema2)) {
  ...
  function validateItems(valid2) {
    gen.forRange("i", items2.length, len, (i) => {
      cxt.subschema({ keyword: keyword2, dataProp: i, dataPropType: util_1$k.Type.Num }, valid2);
      if (!it.allErrors)
...
const def$f = {
  ...
  code(cxt) {
    ...
    it.items = true;
    if ((0, util_1$j.alwaysValidSchema)(it, schema2))
      return;
...
function validateTuple(cxt, extraItems, schArr = cxt.schema) {
  ...
  checkStrictTuple(parentSchema);
  if (it.opts.unevaluated && schArr.length && it.items !== true) {
    it.items = util_1$j.mergeEvaluated.items(gen, schArr.length, it.items);
  }
  const valid2 = gen.name("valid");
  const len = gen.const("len", (0, codegen_1$9._)`${data}.length`);
  schArr.forEach((sch, i) => {
    if ((0, util_1$j.alwaysValidSchema)(it, sch))
      return;
  ...
  function checkStrictTuple(sch) {
    ...
    if (opts.strictTuples && !fullTuple) {
      const msg = `"${keyword2}" is ${l}-tuple, but minItems or maxItems/${extraItems} are not specified or different at path "${errSchemaPath}"`;
      (0, util_1$j.checkStrictMode)(it, msg, opts.strictTuples);
    }
  }
}
...
const def$d = {
  ...
  code(cxt) {
    ...
    const { prefixItems: prefixItems2 } = parentSchema;
    it.items = true;
    if ((0, util_1$i.alwaysValidSchema)(it, schema2))
      return;
    if (prefixItems2)
...
const def$c = {
  ...
  code(cxt) {
    ...
    cxt.setParams({ min, max });
    if (max === void 0 && min === 0) {
      (0, util_1$h.checkStrictMode)(it, `"minContains" == 0 without "maxContains": "contains" keyword ignored`);
      return;
    }
    if (max !== void 0 && min > max) {
      (0, util_1$h.checkStrictMode)(it, `"minContains" > "maxContains" is always invalid`);
      cxt.fail();
      return;
    }
    if ((0, util_1$h.alwaysValidSchema)(it, schema2)) {
...
const def$a = {
  ...
  code(cxt) {
    ...
    const { allErrors, opts } = it;
    it.props = true;
    if (opts.removeAdditional !== "all" && (0, util_1$f.alwaysValidSchema)(it, schema2))
      return;
    ...
    function isAdditional(key) {
      let definedProp;
      if (props.length > 8) {
        const propsSchema = (0, util_1$f.schemaRefOrVal)(it, parentSchema.properties, "properties");
    ...
    function additionalPropertyCode(key) {
      ...
      if (typeof schema2 == "object" && !(0, util_1$f.alwaysValidSchema)(it, schema2)) {
        const valid2 = gen.name("valid");
        if (opts.removeAdditional === "failing") {
          applyAdditionalSchema(key, valid2, false);
    ...
    function applyAdditionalSchema(key, valid2, errors2) {
      const subschema2 = {
        keyword: "additionalProperties",
        dataProp: key,
        dataPropType: util_1$f.Type.Str
      };
      if (errors2 === false) {
        Object.assign(subschema2, {
          compositeRule: true,
...
const def$9 = {
  ...
  code(cxt) {
    ...
    if (it.opts.unevaluated && allProps.length && it.props !== true) {
      it.props = util_1$e.mergeEvaluated.props(gen, (0, util_1$e.toHash)(allProps), it.props);
    }
    const properties2 = allProps.filter((p) => !(0, util_1$e.alwaysValidSchema)(it, schema2[p]));
    if (properties2.length === 0)
      return;
    const valid2 = gen.name("valid");
    for (const prop of properties2) {
...
const def$8 = {
  ...
  code(cxt) {
    ...
    const alwaysValidPatterns = patterns.filter((p) => (0, util_1$d.alwaysValidSchema)(it, schema2[p]));
    if (patterns.length === 0 || alwaysValidPatterns.length === patterns.length && (!it.opts.unevaluated || it.props === true)) {
      return;
    }
    const checkProperties = opts.strictSchema && !opts.allowMatchingProperties && parentSchema.properties;
    ...
    function checkMatchingProperties(pat) {
      for (const prop in checkProperties) {
        if (new RegExp(pat).test(prop)) {
          (0, util_1$d.checkStrictMode)(it, `property ${prop} matches pattern ${pat} (use allowMatchingProperties)`);
        }
      }
    }
    function validateProperties(pat) {
...
const def$3 = {
  ...
  code(cxt) {
    const { gen, parentSchema, it } = cxt;
    if (parentSchema.then === void 0 && parentSchema.else === void 0) {
      (0, util_1$9.checkStrictMode)(it, '"if" without "then" and "else" is ignored');
    }
...
function hasSchema(it, keyword2) {
  const schema2 = it.schema[keyword2];
  return schema2 !== void 0 && !(0, util_1$9.alwaysValidSchema)(it, schema2);
}
_if.default = def$3;
var thenElse = {};
...
const def$2 = {
  ...
  code({ keyword: keyword2, parentSchema, it }) {
    if (parentSchema.if === void 0)
      (0, util_1$8.checkStrictMode)(it, `"${keyword2}" without "if" is ignored`);
  }
};
...
function setupStoreHandlers() {
  ipcMain$1.handle("get-store-value", (_, key) => {
    return store.get(key);
  });
  ipcMain$1.handle("set-store-value", (_, key, value) => {
  ...
  ipcMain$1.handle("delete-store-value", (_, key) => {
    store.delete(key);
  });
  ipcMain$1.handle("clear-store", () => {
    store.clear();
  });
}
class WindowManager {
  constructor() {
    ...
    __publicField(this, "isOverlayMode", false);
  }
  ...
  toggleOverlayMode(enabled) {
    ...
    if (enabled) {
      ...
      const width = 300;
      const height = workArea.height - 50;
      const x = workArea.x + 10;
      const y = workArea.y + 25;
...
ipcMain$1.handle("open-external", async (_, url) => {
  console.log("[MAIN] Opening external URL:", url);
  await shell$1.openExternal(url);
});
ipcMain$1.handle("set-overlay-mode", (_, enabled) => {
...
ipcMain$1.handle("set-mini-mode", (_, enabled) => {
...
function createWindow() {
  ...
  win = new BrowserWindow({
    ...
    webPreferences: {
      preload: path$m.join(__dirname$1, "index.mjs"),
